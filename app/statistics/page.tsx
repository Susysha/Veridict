        ...
        <div className="min-h-screen bg-ink text-text font-sans selection:bg-gold/20 relative overflow-x-hidden">
            ...
            <main className="relative z-10 max-w-6xl mx-auto px-6 py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(180px,auto)]">
                    ...
                    {/* 5. Evaluation Criteria Formula */}
                    <div className="md:col-span-12 bg-panel border border-border rounded-2xl p-8 lg:p-10 relative overflow-hidden group hover:border-gold/30 transition-all duration-500 animate-fade-up delay-400">
